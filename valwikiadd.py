...
poslc = scipy.sparse.csr_matrix(cPickle.load(open('/mnt/scratch/bengio/glorotxa/data/exp/WakaBST4/Brown-corres-lhs.pkl')),dtype='float32')
posrc = scipy.sparse.csr_matrix(cPickle.load(open('/mnt/scratch/bengio/glorotxa/data/exp/WakaBST4/Brown-corres-rhs.pkl')),dtype='float32')
posoc = scipy.sparse.csr_matrix(cPickle.load(open('/mnt/scratch/bengio/glorotxa/data/exp/WakaBST4/Brown-corres-rel.pkl')),dtype='float32')
